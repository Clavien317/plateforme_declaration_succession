...
const Profile = () => {
  return (
    <DefaultLayout>
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark my-9">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <img src="/assets/IMAGE-TESTAMENTOOO-1024x683.png.webp" alt="profile" />
              <label
                htmlFor="profile"
          ...
          <div className="mt-4">
            ...
            <p className="font-medium">Son profession</p>
            <div className="mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                <span className="font-semibold text-black dark:text-white">
                  5
                </span>
                <span className="text-sm">Nombre de publication</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                <span className="font-semibold text-black dark:text-white">
                  129K
                </span>
                <span className="text-sm">Declaration fait</span>
              </div>
            ...
            <div className="mt-6.5">
              <h4 className="mb-3.5 font-medium text-black dark:text-black">
                Follow me on
              </h4>
